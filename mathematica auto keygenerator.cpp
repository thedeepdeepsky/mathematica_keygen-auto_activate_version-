...
int main()
{
	...
	if (m == "Yes")
	{
		...
		cout << "Default address is C://ProgramData/WolframDesktop/Licensing/mathpass(for wolfram one)" << endl;
		cout << "Now if you have finished the things before,please enter your address" << endl;
		string address = "C://ProgramData/WolframDesktop/Licensing/mathpass";
		cout << "If you don't want to use the default address , type 0" << endl;
		bool ifnew = 0;
		cin >> ifnew;
	...
	cout << "Thanks for using,feel free to email sky2319062020@outlook.com" << endl;
